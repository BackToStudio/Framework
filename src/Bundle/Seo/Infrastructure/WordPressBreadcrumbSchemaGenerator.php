...
namespace BackTo\Framework\Bundle\Seo\Infrastructure;
...
/**
 * WordPress implementation of BreadcrumbList schema generation.
 *
 * Uses WordPress query functions (get_queried_object, is_singular, etc.)
 * to build breadcrumbs from the current page context.
 */
class WordPressBreadcrumbSchemaGenerator implements BreadcrumbSchemaGeneratorInterface
{
