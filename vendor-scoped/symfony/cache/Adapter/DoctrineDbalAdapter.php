 ...
 */
namespace BackToVendor\Symfony\Component\Cache\Adapter;

use BackToVendor\Doctrine\DBAL\ArrayParameterType;
use BackToVendor\Doctrine\DBAL\Configuration;
use BackToVendor\Doctrine\DBAL\Connection;
use BackToVendor\Doctrine\DBAL\Driver\ServerInfoAwareConnection;
use BackToVendor\Doctrine\DBAL\DriverManager;
use BackToVendor\Doctrine\DBAL\Exception as DBALException;
use BackToVendor\Doctrine\DBAL\Exception\TableNotFoundException;
use BackToVendor\Doctrine\DBAL\ParameterType;
use BackToVendor\Doctrine\DBAL\Schema\DefaultSchemaManagerFactory;
use BackToVendor\Doctrine\DBAL\Schema\Schema;
use BackToVendor\Doctrine\DBAL\ServerVersionProvider;
use BackToVendor\Doctrine\DBAL\Tools\DsnParser;
...
use BackToVendor\Symfony\Component\Cache\PruneableInterface;
class DoctrineDbalAdapter extends AbstractAdapter implements PruneableInterface
{
    ...
    private function getPlatformName(): string
    {
        ...
        switch (\true) {
            case $platform instanceof \BackToVendor\Doctrine\DBAL\Platforms\MySQLPlatform:
            case $platform instanceof \BackToVendor\Doctrine\DBAL\Platforms\MySQL57Platform:
                return $this->platformName = 'mysql';
            case $platform instanceof \BackToVendor\Doctrine\DBAL\Platforms\SqlitePlatform:
                return $this->platformName = 'sqlite';
            case $platform instanceof \BackToVendor\Doctrine\DBAL\Platforms\PostgreSQLPlatform:
            case $platform instanceof \BackToVendor\Doctrine\DBAL\Platforms\PostgreSQL94Platform:
                return $this->platformName = 'pgsql';
            case $platform instanceof \BackToVendor\Doctrine\DBAL\Platforms\OraclePlatform:
                return $this->platformName = 'oci';
            case $platform instanceof \BackToVendor\Doctrine\DBAL\Platforms\SQLServerPlatform:
            case $platform instanceof \BackToVendor\Doctrine\DBAL\Platforms\SQLServer2012Platform:
