 ...
 */
namespace BackToVendor\Symfony\Component\Lock\Store;
...
use BackToVendor\Symfony\Component\Lock\Exception\InvalidArgumentException;
use BackToVendor\Symfony\Component\Lock\Exception\InvalidTtlException;
...
class DoctrineDbalStore implements PersistingStoreInterface
{
    ...
    public function putOffExpiration(Key $key, $ttl)
    {
        ...
        $result = $this->conn->executeQuery($sql, [$ttl, $uniqueToken, $this->getHashedKey($key), $uniqueToken], [ParameterType::INTEGER, ParameterType::STRING, ParameterType::STRING, ParameterType::STRING]);
    ...
    public function configureSchema(Schema $schema): void
    {
        ...
        $table->addColumn($this->expirationCol, 'integer', ['unsigned' => \true]);
