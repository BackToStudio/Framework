...
use BackToVendor\Predis\Response\ServerException;
...
use BackToVendor\Symfony\Component\Lock\Exception\LockStorageException;
use BackToVendor\Symfony\Component\Lock\Key;
use BackToVendor\Symfony\Component\Lock\PersistingStoreInterface;
use BackToVendor\Symfony\Component\Lock\SharedLockStoreInterface;
/**
...
class RedisStore implements SharedLockStoreInterface
{
    ...
    private function evaluate(string $script, string $resource, array $args)
    {
        ...
        \assert($this->redis instanceof \BackToVendor\Predis\ClientInterface);
        try {
