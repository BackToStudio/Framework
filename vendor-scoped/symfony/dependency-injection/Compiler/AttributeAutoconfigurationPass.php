...
final class AttributeAutoconfigurationPass extends AbstractRecursivePass
{
    ...
    {
        if (!$value instanceof Definition || !$value->isAutoconfigured() || $value->isAbstract() || $value->hasTag('container.ignore_attributes') || !($reflector = $this->container->getReflectionClass($value->getClass(), \false))) {
