...
| [API reference](reference/README.md) | Reference | Complete interface and class documentation |
| [Architecture](explanation/README.md) | Explanation | Design decisions, PSR compliance, WordPress integration |
