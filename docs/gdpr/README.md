...
| [API reference](reference/README.md) | Reference | Interfaces, entities, presets, registries |
| [Architecture](explanation/README.md) | Explanation | Consent flow, rendering separation, cookie security |
